...
<div class="contacts" id="contacts">
    <h1 class="title"><?php the_field('where_title', 2) ?></h1>
    <div class="container">
        <div class="row">
            <div class="col-lg-6">
                <div class="contacts__descr underlined">
                    <?php the_field('where_adress', 2) ?>
                </div>
            </div>
            <div class="col-lg-6">
                <div class="contacts__map">
                    <?php echo do_shortcode('[yamap center="43.2387,76.8542" height="22rem" controls="typeSelector;zoomControl;fullscreenControl" zoom="16" type="yandex#map"][/yamap]') ?>
                </div>
            </div>
        </div>
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <form action="#" class="contacts__feed">
                    <?php echo do_shortcode('[contact-form-7 id="175" title="Форма отзывов"]'); ?>
