<div class="question">
        ...
        <div class="reply">
            <div class="reply__body">
                ...
                <form action="#">
                    <?php echo do_shortcode('[contact-form-7 id="177" title="Отправить письмо"]'); ?>
                        ...
                        <div class="footer__contacts">
                            <div class="footer__contacts-item">
                                ...
                                <div class="footer__contacts-tel">
                                    <a href="tel:<?php the_field('phone1') ?>"><?php the_field('phone1', 2) ?></a>
                                    <a href="tel:<?php the_field('phone2') ?>"><?php the_field('phone2', 2) ?></a>
                                </div>
                            </div>
                            <div class="footer__contacts-item">
